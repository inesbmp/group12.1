This Repo is used to present our Assignment for SAIL Dashboard Challenge.

To use the application
1 Download, to the same Directory, the Q_Max, sensor_data_modified and sensor_location_ines CSV files.
2 Download to this same directory the model_xgb.ipynb and Final_Code_6.py
3 Run All cells in the ipynb
